...
public class Profile extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()){
            if (cursor.getString(3).equals("DONNER")){
            ...
            }else if (cursor.getString(3).equals("HOSPITAL")){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(new Intent(Profile.this,Settings_activity.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startActivity(new Intent(Profile.this,Make_Notification1.class));
